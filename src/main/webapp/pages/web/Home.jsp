...
<%--            pageContext.request.contextPath  : có ý nghĩa lấy ra applicationContext của hệ thống chính là: /WebServlet_1
                                hoàn chỉnh => /WebServlet_1/admin_home--%>
            <a href="${pageContext.request.contextPath}/admin_home" class="w3-bar-item w3-button">Admin</a>
        </div>
    </div>
</div>
